...
# fuggosegek = raw_input(u"Függőségek telepítéséhez írjon be bármilyen értéket - (Enter) Lib-ek telepítésének kihagyása:")
# str(fuggosegek)
# if len(fuggosegek) != 0:
#     print (u"\033[91m {}\033[00m" .format(u"Függőségek telepítése!"))
install()
